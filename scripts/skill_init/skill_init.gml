function skill_init(){
	...
	global.skill_desc[12] = "攻击力<skill>+210%</>,子弹数<debuff>-1</>,攻击变为发射<skill>1x</>法术伤害追踪导弹,命中敌人使其沉默<skill>6</>秒<br><ps>技能自动开启</>";
	...
	global.skill_desc[19] = "攻击间隔<debuff>增大</>,攻击力<skill>+200%</>,攻击变为穿透性射线,并有<skill>25%</>概率使命中目标晕眩<skill>1x</>秒<br><ps>子弹数量影响其扩散角度</>";
	global.skill_spstart[19] = 0;
	global.skill_spneed[19] = 17;
	global.skill_duration[19] = 20;
	global.skill_sptype[19] = sp_type.GetAttacked;
	...
	global.skill_desc[20] = "血量不足一半时,立刻恢复相当于<skill>攻击力180%</>的生命<br><ps>可充能3次,技能自动释放</>";
	global.skill_spstart[20] = 0;
	global.skill_spneed[20] = 4;
	global.skill_duration[20] = 0.5;
	global.skill_sptype[20] = sp_type.Auto;
	global.skill_casttype[20] = cast_type.AutoWhenHPLow;
	...
	global.skill_desc[23] = "攻击变为投掷回旋的大飞镖,短时间内使命中目标每秒受到相当于<skill>攻击力等额</>的法术伤害和<skill>减速</>效果<br><ps>子弹数量仅影响其存在时间</>";
	...
	global.skill_name[24] = "毒液散射";
	global.skill_desc[24] = "攻击力<skill>+50%</>,子弹变为散射,子弹数<skill>+3</><ps>携带此技能时,攻击使目标中毒，在3秒内每秒受到85法术伤害</>";
	global.skill_spstart[24] = 25;
	global.skill_spneed[24] = 40;
	global.skill_duration[24] = 30;
	...
	global.skill_desc[25] = "伤害变为<skill>物理伤害</>,攻击变为<skill>5</>连射,攻击造成<skill>150%</>伤害<br><ps>技能会自动开启</>";
	...
	global.skill_desc[26] = "立刻在前方<skill>1x</>敌人上安放炸弹,炸弹会在一定延迟后引爆,每个对其周围的所有敌人造成<skill>攻击力310%</>的物理伤害并令其晕眩<skill>5</>秒";
	...
	global.skill_desc[27] = "攻击变为<skill>物理伤害</>的单发聚合弹,攻击间隔<debuff>略微增大</>,攻击力<skill>+200%</>";
	...
	global.skill_name[28] = "同步索敌攻击";
	global.skill_desc[28] = "攻击力<skill>+70%</>,释放浮游单元锁定敌人攻击,浮游单元有<skill>50%</>的概率晕眩敌人<skill>1x</>秒<skill>1</>秒<br><ps>携带此技能时获得一个浮游单元</>";
	global.skill_spstart[28] = 20;
	global.skill_spneed[28] = 45;
	global.skill_duration[28] = 30;
	...
	global.skill_desc[29] = "攻击变为<skill>1x</>近战,攻击力<skill>+50%</>,每次攻击随机触发:目标晕眩<skill>1x</>秒或当次攻击力提升至<skill>200%</><br><ps>持续时间无限,可手动关闭</>";
	...
	global.skill_name[31] = "炎爆";
	global.skill_desc[31] = "下次攻击燃烧前方地板,造成<skill>攻击力250%</>的法术伤害,命中目标持续受到灼烧伤害<skill>3</>秒<br><ps>可充能3次,子弹数仅影响其范围</>";
	global.skill_spstart[31] = 0;
	global.skill_spneed[31] = 7;
	global.skill_duration[31] = 1.5;
	global.skill_sptype[31] = sp_type.Auto;
	global.skill_casttype[31] = cast_type.AutoWhenAttack;
	global.skill_charge[31] = 3;
	global.skill_sound[31] = -1;
	...
	global.skill_name[34] = "孢子扩散";
	global.skill_desc[34] = "立即投掷一个小瓶，产生一个持续<skill>2x</>秒的孢子群<br>孢子群范围内所有敌人被停顿且沉默，每秒受到攻击力<skill>80%</>的法术伤害<br><ps>可充能3次</>";
	global.skill_spstart[34] = 10;
	global.skill_spneed[34] = 15;
	global.skill_duration[34] = 1;
	global.skill_sptype[34] = sp_type.Auto;
	global.skill_casttype[34] = cast_type.Cast;
	global.skill_charge[34] = 3;
	global.skill_charge[34] = b_char_tactboost;
	global.skill_name[35] = "爆破回收";
	global.skill_desc[35] = "立即发射引爆所有无人机，造成攻击力<skill>600%</>的法术伤害，并使所有命中目标晕眩2秒<br><ps>被引爆的无人机一段时间后会复活</>";
	global.skill_spstart[35] = 0;
	global.skill_spneed[35] = 30;
	global.skill_duration[35] = 1;
	...
	global.skill_desc[36] = "无人机攻击力<skill>+60%</>且攻击速度<skill>+50</>,自身每秒恢复<skill>50</>点生命<br><ps>请注<black>音<skill>你的  <rare0>14<rare2>04</>触<debuff><outline>手</>";
	...
	global.skill_name[38] = "武装打击模块";
	global.skill_desc[38] = "自身与无人机攻击力<skill>+120%</>,无人机攻击的爆炸范围<skill>扩大</><br><ps>技能结束后,回收所有无人机,一段时间后会复活</>";
	global.skill_spstart[38] = 25;
	global.skill_spneed[38] = 38;
	global.skill_duration[38] = 15;
	global.skill_sptype[38] = sp_type.Auto;
	global.skill_casttype[38] = cast_type.Cast;
	global.skill_charge[38] = 1;
	global.skill_sound[38] = b_char_tactboost;
	global.skill_name[39] = "秘杖·反重力模式";
	global.skill_desc[39] = "攻击力<skill>+200%</>,攻击变为<skill>5x</>自狙击子弹,并造成<skill>3</>秒停顿";
	global.skill_spstart[39] = 10;
	global.skill_spneed[39] = 25;
	global.skill_duration[39] = 25;
	global.skill_sptype[39] = sp_type.Auto;
	global.skill_casttype[39] = cast_type.Cast;
	global.skill_charge[39] = 1;
	global.skill_sound[39] = p_skill_particulateboost;
