...
if d_image_index > 0{text = text + "	_i.image_index = "+string(d_image_index)+";\n"}
...
text = text + "	_i.gravity_direction = "+string(d_gravity_direction)+";\n"}
...
if double{
text = text + "	if i >= "+string(num)+"{\n";
text = text + "		_i.direction = _i.direction+180;\n";
if d_aspd != 0{text = text + "		_i.aspd = -_i.aspd;\n";}
if d_dspd != 0{text = text + "		_i.dspd = -_i.dspd;\n";}
if d_dspd_a != 0{text = text + "		_i.dspd_a = -_i.dspd_a;\n";}
if d_jump_times >= 1{
text = text + "		for(var j = 0;j < "+string(d_jump_times)+";j++){\n";
